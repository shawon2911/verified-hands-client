...
const Workers = () => {
  ...
  const trades = ["Plumber", "Carpenter", "Painter", "AC Technician", "Appliance Repairer"];
  const locations = ["All districts", "Dhaka", "Chattogram", "Khulna", "Mirpur", "Gulshan", "Uttara", "Dhanmondi"];
            ...
            <div>
              ...
              {loading ? (
                ...
                <div className="text-center py-20">
                  <p className="text-[#5b5646]">No workers found matching your filters.</p>
                </div>
              ) : (
                <>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
